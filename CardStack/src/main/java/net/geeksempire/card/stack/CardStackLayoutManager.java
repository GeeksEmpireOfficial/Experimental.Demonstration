...
import net.geeksempire.card.stack.internal.CardStackSetting;
import net.geeksempire.card.stack.internal.CardStackSmoothScroller;
import net.geeksempire.card.stack.internal.CardStackState;
import net.geeksempire.card.stack.internal.DisplayUtil;
...
public class CardStackLayoutManager
    ...
    private void update(RecyclerView.Recycler recycler) {
        ...
        if (state.isSwipeCompleted()) {
             ...
             *
             * 2019-03-31 18:44:29.744 8496-8496/net.geeksempire.card.stack.sample E/AndroidRuntime: FATAL EXCEPTION: main
             *     Process: net.geeksempire.card.stack.sample, PID: 8496
             *     java.lang.IllegalStateException: Cannot call this method while RecyclerView is computing a layout or scrolling net.geeksempire.card.stack.CardStackView{9d8ff78 VFED..... .F....ID 0,0-1080,1353 #7f080027 app:id/card_stack_view}, adapter:net.geeksempire.card.stack.sample.CardStackAdapter@e0b8651, layout:net.geeksempire.card.stack.CardStackLayoutManager@17b0eb6, context:net.geeksempire.card.stack.sample.MainActivity@fe550ca
             ...
             *         at net.geeksempire.card.stack.sample.MainActivity.paginate(MainActivity.kt:164)
             *         at net.geeksempire.card.stack.sample.MainActivity.onCardSwiped(MainActivity.kt:50)
             *         at net.geeksempire.card.stack.CardStackLayoutManager.update(CardStackLayoutManager.java:277)
             *         at net.geeksempire.card.stack.CardStackLayoutManager.scrollHorizontallyBy(CardStackLayoutManager.java:92)
